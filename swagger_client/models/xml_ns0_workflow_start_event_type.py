...
class XmlNs0WorkflowStartEventType(object):
    ...
    def __init__(self):  # noqa: E501
        """XmlNs0WorkflowStartEventType - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, XmlNs0WorkflowStartEventType):
            return False
