...
**base_resource** | **object** | The reference to the resource for which user is responsible for. If not specified then the responsibility is global | [optional] 
**owner** | **object** | The reference to the user assigned to given resource (or globally) with given role | [optional] 
**role** | **object** | The reference to the role that assigned user plays | [optional] 
