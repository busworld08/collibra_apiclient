...
**source_type** | **object** | The reference to the asset type of the source for the relation | [optional] 
**target_type** | **object** | The reference to the asset type of the target for the relation | [optional] 
