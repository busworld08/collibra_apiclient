...
**categorization_relation_type** | [**JsonResourceReferenceImpl**](JsonResourceReferenceImpl.md) | The categorization relation type | [optional] 
**relation_trace** | [**JsonRelationTraceImpl**](JsonRelationTraceImpl.md) |  | [optional] 
**data_quality_metrics** | [**list[JsonDataQualityMetricImpl]**](JsonDataQualityMetricImpl.md) |  | [optional] 
