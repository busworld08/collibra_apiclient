...
**parent** | [**JsonNamedResourceReferenceImpl**](JsonNamedResourceReferenceImpl.md) | The parent community. If not present then this is a top-level community | [optional] 
