...
**domains** | [**list[JsonNamedResourceReferenceImpl]**](JsonNamedResourceReferenceImpl.md) | The list of domains that are included in this scope | [optional] 
**communities** | [**list[JsonNamedResourceReferenceImpl]**](JsonNamedResourceReferenceImpl.md) | The list of communities that are included in this scope | [optional] 
