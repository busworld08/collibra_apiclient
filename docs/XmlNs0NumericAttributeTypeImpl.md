# XmlNs0NumericAttributeTypeImpl
...
**is_integer** | **bool** | Whether the attribute type represents an integer or not | [optional] 
**statistics_enabled** | **bool** | Whether statistics should be tracked for this attribute or not | [optional] 
