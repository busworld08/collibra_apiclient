...
**attribute_types** | **object** | The list of the attribute types that are accepted for the complex relation of this type | [optional] 
**leg_types** | **object** | The list of the leg types representing assets related within complex relation type with given role and co-role | [optional] 
**symbol_data** | **object** | The symbol data of the complex relation type | [optional] 
