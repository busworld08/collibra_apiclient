# XmlNs0MultiValueListAttributeImpl
...
**asset** | **object** | The reference to the asset the attribute belongs to | [optional] 
**type** | **object** | The reference to the type of the attribute | [optional] 
**value** | **str** | The list of string values of the attribute | [optional] 
