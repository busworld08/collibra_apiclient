...
**parent** | [**JsonNamedResourceReferenceImpl**](JsonNamedResourceReferenceImpl.md) | The reference to the parent of the asset type | [optional] 
**symbol_data** | [**JsonSymbolDataImpl**](JsonSymbolDataImpl.md) | The symbol data of the asset type | [optional] 
