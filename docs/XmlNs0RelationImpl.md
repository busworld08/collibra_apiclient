...
**source** | **object** | The reference to the source asset of the relation | [optional] 
**starting_date** | **float** | The timestamp representing the starting date of the relation | [optional] 
**target** | **object** | The reference to the target asset of the relation | [optional] 
**type** | **object** | The type of the relation | [optional] 
