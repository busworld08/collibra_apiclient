...
**base_resource** | **object** | The reference to the base resource the file is attached to | [optional] 
**file** | **object** | The reference to the file contained by this attachment | [optional] 
